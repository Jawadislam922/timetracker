    ...
    public function run(): void
    {
        $articles = [
            ...
            [
                ...
                'keywords' => 'dashboard numbers in office tracked work break week month calculation confusing dont match different why less midnight night shift work day',
                'body' => "Every card on your dashboard counts **your work day** — the day your shift belongs to. If you work evenings or nights, your work day does **not** reset at midnight; it runs until your shift's day is over. So working at 1 AM still counts toward the same day you clocked in.\n\n- **In Office** — how long you've been clocked in this work day (clock-in to clock-out, minus breaks). This is *presence*.\n- **Tracked Work** — what the desktop tracker actually recorded this work day, plus any manual Work Diary hours. This is *recorded work*.\n- **In Office is usually higher than Tracked** — that's normal. Meetings, calls, thinking, and idle moments count as presence but not tracked work.\n- **Break Time** — your breaks this work day. Breaks pause the tracker.\n- **Week** — in-office hours since **Monday**. **Month** — in-office hours since the **1st**.\n\n**\"Why is my Week bigger than my Month?\"** In the first days of a month this is correct: the week can include days from the end of last month, which the month column doesn't count. It evens out within a few days.\n\n**One more thing:** the **Timeline** page and charts show *calendar dates* — work after midnight appears on the next date's page there. Your dashboard and the desktop app's \"today\" always follow your work day instead.",
            ],
            [
                'category' => 'How it works',
