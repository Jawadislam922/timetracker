                                ...
                                <div className="bg-slate-900 rounded-lg p-4 border-2 border-slate-800">
                                    <label className="flex items-center cursor-pointer">
                                        <input
                                            ...
                                            className="w-5 h-5 rounded border-slate-700 bg-slate-900 [color-scheme:dark] text-orange-500 focus:ring-2 focus:ring-orange-500 transition-all duration-200"
                                        />
