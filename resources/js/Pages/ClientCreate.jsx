                                ...
                                {form.data.name && (
                                    <div className="p-6 bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-xl rounded-xl border border-white/20">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                            ...
                                            {selectedProfiles.length > 0 && (
                                                <div>
                                                    <p className="text-sm text-white/60 mb-1">Upwork Profiles:</p>
                                                    <div className="flex flex-wrap gap-2">
                                                        {selectedProfiles.map((profile) => (
                                                            <span
                                                                key={profile.id}
                                                                className="inline-flex px-3 py-1 text-xs font-medium bg-purple-500/20 text-purple-300 rounded-md backdrop-blur-xl border border-purple-400/30"
                                                            >
                                                                {profile.name}
                                                            </span>
                                                        ))}
